...
<link href="<c:url value='/assets/global/css/components-rounded.css'/>"
	id="style_components" rel="stylesheet" type="text/css" />
<link href="<c:url value='/assets/global/css/plugins.css'/>"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/assets/admin/layout/css/layout.css'/>"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/assets/admin/layout/css/themes/argos.css'/>"
	rel="stylesheet" type="text/css" id="style_color" />
<link href="<c:url value='/assets/admin/layout/css/custom.css'/>"
	rel="stylesheet" type="text/css" />
<!-- END THEME STYLES -->
...
<link rel="shortcut icon"
	href="<c:url value='/assets/admin/layout/img/favicon.ico'></c:url>" />
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li><i class="fa fa-home"></i> <a href="<c:url value="/"/>">Inicio</a>
...
<![endif]-->
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<c:url value='/assets/global/plugins/jquery.cokie.min.js'/>"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src='<c:url value="/assets/global/plugins/bootbox/bootbox.min.js"></c:url>'
		type="text/javascript"></script>
	<script
		src='<c:url value="/assets/global/plugins/bootbox/bootbox.locales.min.js"></c:url>'
		type="text/javascript"></script>
	<!-- END CORE PLUGINS -->
	...
	<script src="<c:url value='/assets/global/scripts/metronic.js'/>"
		type="text/javascript"></script>
