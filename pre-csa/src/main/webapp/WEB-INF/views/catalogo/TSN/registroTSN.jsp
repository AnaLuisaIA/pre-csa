...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="title">Registro Tasa Sobre Nomina</tiles:putAttribute>
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<h3>
									<i class="fa fa-edit"></i> Alta de Tasa Sobre Nomina | <small
									...
									<div class="row">
											<div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="estado" id="estado" class="form-control" placeholder="Ingrese el estado"/>
                                                </div>
											</div>
											<div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <option>Seleccione un Tipo de Nómina</option>
											...
											<div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select required="true" class="form-control">
                                                    <option>Seleccione un Tipo de Variable</option>
                                                    <option>Tasa</option>
                                                    <option>Total a Pagar</option>
                                                    </select>
                                                   </div>
											</div>
										</div>
