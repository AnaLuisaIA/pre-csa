package com.sadss.csa.dao.generic;
...
import com.sadss.csa.util.HibernateUtilsCustom;
...
public abstract class AbstractHibernateDao<T extends Serializable> implements IOperations<T> {
    ...
    public final void update(final T entity) {
        Preconditions.checkNotNull(entity);
        getCurrentSession().update(entity); //[2019-09-02] Se cambia método merge por update
    }
	...
	public void validateSoftDelete(T entity) throws DataIntegrityViolationException {
		...
		Map<String, List<String[]>> assoc = HibernateUtilsCustom.getMappingAssocations(getCurrentSession().getSessionFactory(), "egresoslife", ""); //, clazz.getName());
