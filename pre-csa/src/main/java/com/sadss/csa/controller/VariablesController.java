...
public class VariablesController {
	...
	/**
	 * M�todo para encontrar los registros de variables
	 */
	...
	/*
	 * M�todo para editar una Variable
	 * 
	 * @param id (id de la variable)
	 * 
	 * @param model (Modeo vac�o)
	 *
	 */
	...
	public ModelAndView agregarVariable(@Valid @ModelAttribute("variable") VariablesForm variable,
		...
		if (modeloVariable.getId() == null) {
			...
			//SI EL VALOR DE LA VARIABLE NO CAMBI�
			if (modeloPeriodo.getValor().equals(variable.getValorn())) {
				...
				if(modeloPeriodo.getFechaTermino() == null) {
					...
					variablesService.registrarAccionBitacoraG("Modificaci�n  de variable : " + variable.getNombre(), new Date(), colaborador);

					variablesService.registrarAccionBitacora("Modificaci�n de variable : " + variable.getNombre(), new Date(), 
							variable.getJustificacion(), colaborador);
				}else {
					...
					variablesService.registrarAccionBitacoraG("Modificación de variable : " + variable.getNombre(), new Date(), colaborador);

					variablesService.registrarAccionBitacora("Modificación de variable : " + variable.getNombre(), new Date(), 
							variable.getJustificacion(), colaborador);
				...
				variablesService.registrarAccionBitacoraG("Modificaci�n en el valor de variable : " + variable.getNombre() + " , de  Valor: "
						+ variable.getValorn() + " al Valor: " + variable.getValor(), new Date(), colaborador);

				variablesService.registrarAccionBitacora("Modificaci�n en el valor de variable : " + variable.getNombre(), new Date(), 
				variable.getJustificacion(), colaborador);
			}
	...
	/**
	 * M�todo para eliminar una variable
	 */
