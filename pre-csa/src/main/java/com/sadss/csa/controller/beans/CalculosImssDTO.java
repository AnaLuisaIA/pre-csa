...
public class CalculosImssDTO {
	...
	public CalculosImssDTO(Integer id, Integer claveAgente, BigDecimal cuotaFijaP, BigDecimal excedenteP,
			BigDecimal prestacionesP, BigDecimal gastosMedP, BigDecimal RTP, BigDecimal guarderiaP, BigDecimal invVidaP,
			BigDecimal totalPatron, BigDecimal excedenteT, BigDecimal prestacionesT, BigDecimal gastosMedicosT,
			BigDecimal invVidaT, BigDecimal totalTrabajador, BigDecimal totalIMSS, BigDecimal infonavitPatron,
			BigDecimal infonavitTrabajador, BigDecimal totalInfonavit, Date fechaCalculo, Date periodoInicio,
			Date periodoFin, String nombres, String aPaterno, String aMaterno, String numColaborador) {
	...
	public CalculosImssDTO(Integer id, BigDecimal totalPatron, BigDecimal totalTrabajador, BigDecimal totalIMSS,
